...
public class Main
{
	public static void main(String args[])
	{
		...
		Account account1 = new Account("KutxaBank", 150.00d, address1);
		Account account2 = new Account("Banco Santander", 45.00d, address2);
		Account account3 = new Account("Caja Laboral", 290.00d, address1);
